...
# 이미 기능 구현된 라우트는 건너뜀
SKIP_ROUTES={"/paper/make","/paper/mypaper","/management/student","/management/teacher","/management/class","/management/attendance","/management/book","/clinic/studentmark","/clinic/report","/management/centerinfo","/mypage/profile","/clinic/class","/management/statistic"}  # 기능 구현분 보존
def path_to_route(p):
